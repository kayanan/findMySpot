    ...
    const fetchData = async () => {
      ...
      try {
        const res = await axios.get(
          `${import.meta.env.VITE_BACKEND_ADMIN_URL}/v1/users/list?role=PARKING_OWNER&approvalStatus=${filters.approvalStatus}&isActive=${filters.isActive}`,
              ...
              <tbody>
                {filteredOwners.map((owner) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4">{owner.mobile}</td>
