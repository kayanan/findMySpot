      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="shadow-md rounded-lg p-6 flex flex-col items-center bg-gray-100">
          ...
          <div className="mt-4 text-center">
            <h2 className="text-2xl font-bold capitalize">{Role.type}</h2>
          </div>
        </div>
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <span
              className={`text-base font-semibold px-2 py-1 rounded ${Role.isActive === true
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-base font-semibold">{Role.type}</p>
            </div>
          </div>
        </div>
      </div>
