...
const AddUser = () => {
    ...
    if (!trimmedValue) {
      ...
      switch (field) {
        ...
        case "confirmPassword":
          if (formData.password.trim() !== trimmedValue) errorMessage = "not Match.";
          break;
        default:
          break;
      }
  ...
  const handleSubmit = async (e) => {
    ...
    if (passwordStrength < 3) { // Require at least "Good" password
      // Trigger Toastify error notification
  ...
  return (
    <div className="p-6 my-2 max-w-4xl mx-auto bg-white rounded-lg shadow-lg">
      <h1 className="text-3xl font-bold text-cyan-500 mb-6 text-center">Add New User</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            {errors.firstName && ( // Show error message if validation fails
              <p className="text-red-500 text-sm">First Name is {errors.firstName}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.lastName && ( // Show error message if validation fails
              <p className="text-red-500 text-sm">Last Name is {errors.lastName}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            />
            {errors.mobile && <p className="text-red-500 text-sm">Mobile Number is {errors.mobile}</p>}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              onBlur={() => handleBlur("address")} // Add onBlur for validation
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              onBlur={() => handleBlur("designation")} // Add onBlur for validation
            ...
            {errors.designation && <p className="text-red-500 text-sm">Designation is {errors.designation}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              onBlur={() => handleBlur("username")} // Add onBlur for validation
        ...
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            onBlur={() => handleBlur("branchId")} // Add onBlur for validation
            className={`w-full p-2 border rounded focus:outline-none focus:ring-2 ${errors.branchId ? "border-red-500" : "border-gray-300"
              } focus:ring-cyan-500`}
          >
          ...
          {errors.branchId && <p className="text-red-500 text-sm">Branch is {errors.branchId}</p>}
        </div>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-4 mt-2">
            {["View Users", "Add User", "View User", "Update User", "View branches", "Add branch", "Update branch", "View branch"].map((privilege) => (
