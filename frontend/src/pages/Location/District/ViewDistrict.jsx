  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="shadow-md rounded-lg p-6 flex flex-col items-center bg-gray-100">
          ...
          <div className="mt-4 text-center">
            <h2 className="text-2xl font-bold capitalize">{District.name}</h2>
          </div>
        </div>
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-base font-semibold">{District.name}</p>
            </div>
          </div>
        </div>
      </div>
      <div className="grid md:grid-cols-1 mt-6">
        <div className="p-2">
          <CityList District={District} Province={Province} />
        </div>
      </div>
    </div>
  );
